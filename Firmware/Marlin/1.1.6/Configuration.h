 ...
 *
 * This program is free software: ykou can redistribute it and/or modify
...
#define STRING_CONFIG_H_AUTHOR "mzolin (MZBot) et al." // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "VORON 1.5" // will be shown during bootup in line 1
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 555.76 }
